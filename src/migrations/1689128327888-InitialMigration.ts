...
export class InitialMigration1689128327888 implements MigrationInterface {
    name = 'InitialMigration1689128327888'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "order" DROP COLUMN "productsId"`);
        await queryRunner.query(`ALTER TABLE "order" ADD "productsId" character varying NOT NULL`);
