...
export class InitialMigration1708822821044 implements MigrationInterface {
    name = 'InitialMigration1708822821044'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."order_status_enum" AS ENUM('pending', 'finish')`);
        await queryRunner.query(`CREATE TYPE "public"."order_order_type_enum" AS ENUM('delivery', 'take', 'salloon')`);
        await queryRunner.query(`CREATE TABLE "order" ("id" SERIAL NOT NULL, "status" "public"."order_status_enum" NOT NULL, "comments" character varying, "createdAt" date NOT NULL DEFAULT now(), "updatedAt" date NOT NULL DEFAULT now(), "deletedAt" date, "total" double precision NOT NULL, "order_type" "public"."order_order_type_enum" NOT NULL, "clientId" uuid, "establishId" uuid, "addressId" uuid, "menuId" integer, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
